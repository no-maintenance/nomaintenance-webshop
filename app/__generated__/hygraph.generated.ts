...
export type Layout = Entity & Node & {
  ...
  /** The unique identifier */
  id: Scalars['ID']['output'];
  isFluidHero?: Maybe<Scalars['Boolean']['output']>;
  /** System Locale field */
  locale: Locale;
  /** Get the other localizations for this document */
...
export type LayoutCreateInput = {
  ...
  isFluidHero?: InputMaybe<Scalars['Boolean']['input']>;
  /** Inline mutations for managing document localizations excluding the default locale */
...
export type LayoutManyWhereInput = {
  ...
  isFluidHero?: InputMaybe<Scalars['Boolean']['input']>;
  /** Any other value that exists and is not equal to the given value. */
  isFluidHero_not?: InputMaybe<Scalars['Boolean']['input']>;
...
export enum LayoutOrderByInput {
  ...
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  IsFluidHeroAsc = 'isFluidHero_ASC',
  IsFluidHeroDesc = 'isFluidHero_DESC',
...
type Heroes_Collection_Fragment = { __typename: 'Collection', gid: string, id: string };

type Heroes_Editorial_Fragment = { __typename: 'Editorial', title?: string | null, id: string, slug: string, excerpt?: { __typename?: 'RichText', html: string } | null, featuredMedia?: { __typename: 'Asset', id: string, alt?: string | null, mimeType?: string | null, height?: number | null, width?: number | null, url: string, image: string, thumbnail: string, small: string, medium: string, large: string, xlarge: string, portrait?: { __typename: 'Asset', id: string, alt?: string | null, mimeType?: string | null, height?: number | null, width?: number | null, url: string, image: string, thumbnail: string, small: string, medium: string, large: string, xlarge: string } | null } | null };
...
type Heroes_Product_Fragment = { __typename: 'Product', gid: string, id: string };
