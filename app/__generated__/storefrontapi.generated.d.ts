...
export type FeaturedProductsByIdsQuery = { nodes: Array<StorefrontAPI.Maybe<(
    Pick<StorefrontAPI.Product, 'id' | 'title' | 'publishedAt' | 'handle' | 'vendor' | 'descriptionHtml'>
    & { media: { nodes: Array<(
        { __typename: 'ExternalVideo' }
        & Pick<StorefrontAPI.ExternalVideo, 'id' | 'embedUrl' | 'host' | 'mediaContentType' | 'alt'>
        & { previewImage?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Image, 'url'>> }
        ...
        Pick<StorefrontAPI.ProductVariant, 'title' | 'id' | 'availableForSale'>
        & { price: Pick<StorefrontAPI.MoneyV2, 'amount' | 'currencyCode'>, compareAtPrice?: StorefrontAPI.Maybe<Pick<StorefrontAPI.MoneyV2, 'amount' | 'currencyCode'>>, selectedOptions: Array<Pick<StorefrontAPI.SelectedOption, 'name' | 'value'>>, product: Pick<StorefrontAPI.Product, 'handle' | 'title'> }
      )> }, options: Array<Pick<StorefrontAPI.ProductOption, 'name' | 'values' | 'id'>> }
  )>> };
...
interface GeneratedQueryTypes {
  "#graphql\nquery homepageFeaturedCollections($country: CountryCode, $language: LanguageCode)\n@inContext(country: $country, language: $language) {\n    collections(\n        first: 4,\n        sortKey: UPDATED_AT\n    ) {\n        nodes {\n            id\n            title\n            handle\n            image {\n                altText\n                width\n                height\n                url\n            }\n        }\n    }\n}\n": {return: HomepageFeaturedCollectionsQuery, variables: HomepageFeaturedCollectionsQueryVariables},
  "#graphql\nquery CollectionInfo(\n    $id: ID!\n    $country: CountryCode\n    $language: LanguageCode\n) @inContext(country: $country, language: $language) {\n    collection(id: $id) {\n        id\n        handle\n        title\n        descriptionHtml\n        image {\n            id\n            url\n            width\n            height\n            altText\n        }\n    }\n}\n": {return: CollectionInfoQuery, variables: CollectionInfoQueryVariables},
  "#graphql\nquery FeaturedProductsByIds($ids: [ID!]!, $country: CountryCode, $language: LanguageCode) @inContext(country: $country, language: $language)  {\n    nodes(ids: $ids) {\n        ... on Product {\n            id\n            title\n            publishedAt\n            handle\n            vendor\n            descriptionHtml\n            media(first: 6) {\n                nodes {\n                    ...Media\n                }\n            }\n            variants(first: 10) {\n                nodes {\n                    title\n                    id\n                    availableForSale\n                    price {\n                        amount\n                        currencyCode\n                    }\n                    compareAtPrice {\n                        amount\n                        currencyCode\n                    }\n                    selectedOptions {\n                        name\n                        value\n                    }\n                    product {\n                        handle\n                        title\n                    }\n                }\n            }\n            options {\n                name\n                values\n                id\n            }\n        }\n    }\n}\n#graphql\nfragment Media on Media {\n    __typename\n    mediaContentType\n    alt\n    previewImage {\n        url\n    }\n    ... on MediaImage {\n        id\n        image {\n            id\n            url\n            width\n            height\n        }\n    }\n    ... on Video {\n        id\n        sources {\n            mimeType\n            url\n        }\n    }\n    ... on Model3d {\n        id\n        sources {\n            mimeType\n            url\n        }\n    }\n    ... on ExternalVideo {\n        id\n        embedUrl\n        host\n    }\n}\n\n": {return: FeaturedProductsByIdsQuery, variables: FeaturedProductsByIdsQueryVariables},
  "#graphql\nquery CollectionFeed(\n    $id: ID!\n    $country: CountryCode\n    $language: LanguageCode\n    $first: Int\n) @inContext(country: $country, language: $language) {\n    collection(id: $id) {\n        id\n        handle\n        title\n        descriptionHtml\n        image {\n            id\n            url\n            width\n            height\n            altText\n        }\n        products(\n            first: $first,\n        ) {\n            nodes {\n                ...ProductCard\n            }\n        }\n    }\n}\n#graphql\nfragment ProductCard on Product {\n    id\n    title\n    publishedAt\n    handle\n    vendor\n    media(first: 2) {\n        nodes {\n            ...Media\n        }\n    }\n    variants(first: 10) {\n        nodes {\n            title\n            id\n            availableForSale\n            price {\n                amount\n                currencyCode\n            }\n            compareAtPrice {\n                amount\n                currencyCode\n            }\n            selectedOptions {\n                name\n                value\n            }\n            product {\n                handle\n                title\n            }\n        }\n    }\n}\n#graphql\nfragment Media on Media {\n    __typename\n    mediaContentType\n    alt\n    previewImage {\n        url\n    }\n    ... on MediaImage {\n        id\n        image {\n            id\n            url\n            width\n            height\n        }\n    }\n    ... on Video {\n        id\n        sources {\n            mimeType\n            url\n        }\n    }\n    ... on Model3d {\n        id\n        sources {\n            mimeType\n            url\n        }\n    }\n    ... on ExternalVideo {\n        id\n        embedUrl\n        host\n    }\n}\n\n\n": {return: CollectionFeedQuery, variables: CollectionFeedQueryVariables},
  "#graphql\nquery layout(\n    $language: LanguageCode\n) @inContext(language: $language) {\n    shop {\n        ...Shop\n    }\n\n}\nfragment Shop on Shop {\n    id\n    name\n    description\n    primaryDomain {\n        url\n    }\n    brand {\n        logo {\n            image {\n                url\n            }\n        }\n    }\n}\n": {return: LayoutQuery, variables: LayoutQueryVariables},
  "#graphql\n    query getShopPrimaryDomain { shop { primaryDomain { url } } }\n    ": {return: GetShopPrimaryDomainQuery, variables: GetShopPrimaryDomainQueryVariables},
