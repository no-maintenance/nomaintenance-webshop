...
const CarouselWithCounter = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & CarouselProps
>(({children, ...props}, ref) => {
              ...
              >
                <m.span
                  className={`w-full h-[1px] ${
                    current === i ? 'bg-black' : 'bg-black/50'
                  }`}
                ></m.span>
              </m.button>
            );
...
CarouselWithCounter.displayName = 'CarouselWithCounter';
...
const CarouselPrevious = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<typeof Button> & {isInline?: boolean}
>(
  (
    {className, isInline = false, variant = 'outline', size = 'icon', ...props},
    ref,
  ) => {
